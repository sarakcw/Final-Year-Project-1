    ...
    <div class="row pb-5 mb-5 justify-content-center">
        <div class="col-md-8">
            <div class="admin-form mt-3 mb-2 mx-auto">
                ...
                <p class="text-center text-muted">Fill out this form to add a new product to the database.</p>
                <div class=card-body>
                    ...
                    <div class="row">
                        ...
                        <?= $this->Form->control('stock_quantity', ['label' => 'Stock Quantity *', 'class' => 'form-control', 'placeholder'=>'Enter stock quantity','type' =>'number', 'required' => true]);?>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                           ...
                           <?=  $this->Form->control('vintage', ['label' => 'Vintage Year *',
                                    ...
                                    'class' => 'select form-control', 'required' => true]);?></div>
                            <div class="col-md-6 mb-3">
                    ...
                    <div class="text-end">
                        ...
                        <?= $this->Form->button(__('Add New Product'), ['class' => 'btn  admin-btn-submit']) ?>
                    </div>
                    <?= $this->Form->end() ?>
